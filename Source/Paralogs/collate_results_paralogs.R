...
results_directory                    <- paste( base_directory, "Results/Bootstrap_p_values/Paralogs_Not_Randomize_GI/", sep="")
...
triplet_motifs_full_results_file     <- "full_results_table_orthomcl_paralogs_in_tri_motifs.tab"
count_triplet_motifs_randomized_file <- "randomized_counts_orthomcl_paralogs_in_tri_motifs.tab" 

triplet_motifs_file_pattern      	 <- "^randomized_counts_orthomcl_paralogs_in_tri_motifs.tab"
observed_file_pattern        		 <-  "Job_20/observed_counts_orthomcl_paralogs_in_tri_motifs.tab"
