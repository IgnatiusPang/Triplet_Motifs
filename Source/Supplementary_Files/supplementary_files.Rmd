...
## Helper Codes: Build phenotype master table 
```{r}
...
## Table S9. The list of all the triplets in the filtered integrated network and triplets with genes that are cell cycle-regulated, essential and toxic on overexpression, and their shared phenotype on knockout and GO slim terms.
```{r}
...
# Kinase-substrate network
 ...
 sbi_interactome %>%
  ...
  # Number of proteins
 c( sbi_interactome [, "oln_id_a"], sbi_interactome [, "oln_id_b"] ) %>% unique() %>% length()
