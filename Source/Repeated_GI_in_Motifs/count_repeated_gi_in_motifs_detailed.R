...
### Local Parameters
if (is_run_locally) {
	results_directory <- "./Results/Bootstrap_p_values_temp/Repeated_GI_in_Motifs_Detailed/"
...
observed_counts_unique_gi_pairs_in_motifs <- count_repeated_gi_in_triplet_motifs_detailed( triplet_motifs_costanzo)
...
randomized_counts_unique_gi_pairs_in_motifs_list <- mclapply ( X=1:number_of_randomized_trials, 
													  ...
													  count_repeated_gi_in_triplet_motifs_detailed, 
													  mc.set.seed = TRUE , 
