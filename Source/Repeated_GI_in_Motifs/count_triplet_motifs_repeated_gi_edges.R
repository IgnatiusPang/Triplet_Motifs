...
observed_counts_unique_gi_pairs_in_motifs <- count_triplet_motifs_unique_gi_pairs( triplet_motifs_costanzo)


observed_counts_unique_gi_pairs_in_motifs <- transpose_count_triplet_motifs_results(observed_counts_unique_gi_pairs_in_motifs, 
...
# 																  num_iterations=100, 
# 																  count_triplet_motifs_unique_gi_pairs)
...
randomized_counts_unique_gi_pairs_in_motifs <- concat_motif_counts_list_into_table( randomized_counts_unique_gi_pairs_in_motifs_list) 

write.table ( randomized_counts_unique_gi_pairs_in_motifs, file = paste( results_directory, randomized_counts_unique_gi_pairs_in_motifs_file, sep=""), 
			  row.names = FALSE)
