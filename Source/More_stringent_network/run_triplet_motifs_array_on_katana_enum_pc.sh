...
PERCENTAGE_OF_ORIGINAL_NETWORK=$( seq 5 5 100 )
...
QUANTILE=${network_size_proportion}
PROJECT_DIRECTORY="More_stringent_network_${QUANTILE}"
MAIN_SCRIPT="count_triplet_motifs_more_stringent_v2.R"
HPC_CLUSTER="katana"
NUM_RANDOM_TRIALS=100
LOG_PREFIX="count_motifs_more_stringent_${QUANTILE}"
...
COMMAND_TO_RUN="Rscript --vanilla ${MAIN_SCRIPT} ${HPC_CLUSTER} ${PBS_ARRAYID} ${NUM_RANDOM_TRIALS} ${QUANTILE} > ${LOG_PREFIX}_${PBS_ARRAYID}_$DATE.log 2>&1"
