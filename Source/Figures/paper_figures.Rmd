...
## Analyze how filtering the negative genetic interaction by the stringency in fitness score affects the six types of triplet motifs. 
```{r}
...
ggsave(file.path(figures_results_directory, paste( "analyze_gi_edges_wrap", figure_file_suffix, sep="")), 
	   plot=last_plot(), width=10.3, height=7.5 ) # , width=10, height=7
```
...
motif_type_significance_box_plot_vertical_stack_faceting( result_list$observed_data, 
														  ...
														  output_file_name, graphic_width, graphic_height*2)
