...
results_directory                    <- paste( base_directory, "Results/Bootstrap_p_values/Overexpressed_Toxic_Genes/", sep="")
...
## A--B
triplet_motifs_full_results_file     <- "full_results_table_overexpressed_toxic_gene_counts_a_and_b.tab"
count_triplet_motifs_randomized_file <- "randomized_results_table_overexpressed_toxic_gene_counts_a_and_b.tab" 

triplet_motifs_file_pattern      	 <- "^randomized_results_table_overexpressed_toxic_gene_counts_a_and_b.tab"
observed_file_pattern        		 <-  "Job_20/observed_a_and_b_overexpressed_toxic_gene_counts.tab"
...
## C
triplet_motifs_full_results_file     <- "full_results_table_overexpressed_toxic_gene_counts_c.tab"
count_triplet_motifs_randomized_file <- "randomized_results_table_overexpressed_toxic_gene_counts_c.tab" 

triplet_motifs_file_pattern      	 <- "^randomized_results_table_overexpressed_toxic_gene_counts_c.tab"
observed_file_pattern        		 <-  "Job_20/observed_c_overexpressed_toxic_gene_counts.tab"
